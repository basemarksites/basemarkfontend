...
export default class HotSales extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:3001/hotSales', this.config)
            .then((response) => {
                const data = response.data;
    ...
    addItems = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3001/hotSales', { product: this.state.hotItems }, this.config)
            .then((response) => {
    ...
    removeItems = (itemId) => {
        axios.delete(`http://localhost:3001/hotSales/${itemId}`, this.state.config)
            .then((response) => {
                alert("Item removed.")
            ...
            <div>
                <Container>
                    ...
                    <FormGroup>
                        ...
                        <Input type="select" name="hotItems" id="hotItems" value={this.state.hotItems}
